...
# @Last Modified time: 2018-11-07 13:17:28
import sys
import torch
import visdom
import argparse
...
def train(args):
    ...
    if args.visdom:
        vis = visdom.Visdom(env='cm_8_sub')
    ...
    #for epoch in range(0, args.n_epoch):
        ...
        torch.save(state, "{}_{}_{}_best_model.pkl".format(epoch,args.arch,args.dataset))

if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Hyperparams')
    parser.add_argument('--arch', nargs='?', type=str, default='cm_sub_8',
    ...
    parser.add_argument('--resume', nargs='?', type=str, default='/home/lidong/Documents/CMF/17_cm_sub_8_flying3d_best_model.pkl',
