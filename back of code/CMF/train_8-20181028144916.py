...
# @Last Modified time: 2018-10-26 22:43:23
import sys
import torch
import visdom
import argparse
...
def train(args):
    ...
    if args.visdom:
        vis = visdom.Visdom(env='sceneflow_8_cmfsm')
    ...
    if args.resume is not None:
        ...
        resnet34=torch.load('/home/lidong/Documents/CMF/15_bilinear_cmf_sub_8_flying3d_best_model.pkl')
