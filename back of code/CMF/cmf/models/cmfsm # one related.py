...
# @Last Modified time: 2018-10-15 21:42:34
# -*- coding: utf-8 -*-
# @Author: lidong
...
class feature_extraction(nn.Module):
    ...
    def forward(self, x):
        ...
        output_rt = self.layer1(output_all)
...
class cmfsm(nn.Module):
    ...
    def __init__(self, 
        ...
        self.mapping_matrix=self.context_mapping()
    ...
    def forward(self, left, right):
        ...
        cost3=cost3.unsqueeze(-1).expand(cost3.shape[0],cost3.shape[1],cost3.shape[2],cost3.shape[3],scale) \
                                  ...
                                  .unsqueeze(-3).expand(cost3.shape[0],cost3.shape[1],scale,cost3.shape[2],cost3.shape[3]*scale) \
