...
class cmfsm_sub_8(nn.Module):
    ...
    def forward(self, left, right):
        ...
        # cost1 = torch.squeeze(cost1, 1)
        cost1[...,scale:-scale,scale:-scale]=cost1[...,scale:-scale,scale:-scale]*mapping[...,scale:-scale,scale:-scale] \
            + cost1[...,scale:-scale,scale:-scale]*mapping_r[...,scale:-scale,scale:-scale]+cost1[...,scale:-scale,scale:-scale]*mapping_l[...,scale:-scale,scale:-scale] \
            + cost1[...,scale:-scale,scale:-scale]*mapping_t[...,scale:-scale,scale:-scale]+cost1[...,scale:-scale,scale:-scale]*mapping_b[...,scale:-scale,scale:-scale]
        #fused=cost1*mapping
        # cost1[...,:-scale]=cost1[...,:-scale]+cost1[...,scale:]*mapping_r[...,:-scale]
        # cost1[...,scale:]=cost1[...,scale:]+cost1[...,:-scale]*mapping_l[...,scale:]
        # cost1[...,scale:,:]=cost1[...,scale:,:]+cost1[...,:-scale,:]*mapping_t[...,scale:,:]
        # cost1[...,:-scale,:]=cost1[...,:-scale,:]+cost1[...,scale:,:]*mapping_b[...,:-scale,:]
        # #target
        # #print(cost1.shape)
        # #exit()
